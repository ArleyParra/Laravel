    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="img/logo_naranja.png" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
            </a>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Hermoso PC con aire acondicionado</p>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">computador</h5>
                        <p class="card-text">Hermoso PC con aire acondicionado</p>
                        <a href="#" class="btn btn-primary my-background">Añadir</a>
                    </div>
                </div>
            </div>
        </div>
